  ...
  function addInitialRes() {
    ...
    for (var i = 0; i < num; i++) {
      ...
      text.style.backgroundColor =  "rgb(0, 255, 255)";
    ...
    if (isNaN(num)) {
      ...
      p1.textContent = "Maximum resources needed: ";
      d1.appendChild(p1);
      for (var i = 0; i < num; i++) {
        var card = document.createElement("div");
      ...
      p2.textContent = "Already allocated:   ";
      d2.appendChild(p2);
      for (var i = 0; i < num; i++) {
        var card = document.createElement("div");
        card.setAttribute("style", "width:90px;float:left;margin-right:50px;height:50px;");
  ...
  function safe_sequence() {
    ...
    if (count == 0) {
      ...
      var d6 = document.createElement("div");
      h2 = document.createElement("h5");
      h2.textContent = "OS cannot accomodate the above request ";
      output2.appendChild(h2);
    }
  }
  function add() {
